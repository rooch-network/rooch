...
use crate::{
    ...
    file_format::{
        AbilitySet, Signature, SignatureToken, StructHandleIndex, StructTypeParameter, Visibility,
    },
    file_format_common::VERSION_5,
    views::{ModuleView, StructHandleView, ViewInternals},
    CompiledModule,
};
