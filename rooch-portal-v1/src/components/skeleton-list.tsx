...
export const SkeletonList = () => {
  return (
    <div
      role="status"
      className="w-full p-4 space-y-4 border border-zinc-200 divide-y divide-zinc-200 rounded-lg shadow animate-pulse dark:divide-zinc-700 md:p-6 dark:border-zinc-700"
    >
