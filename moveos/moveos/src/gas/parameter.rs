...
static G_NATIVE_STRS: Lazy<Vec<&str>> = Lazy::new(|| {
    vec![
        ...
        "object.native_add_field.per_byte_serialized",
        "object.native_borrow_field.per_byte_serialized",
        "object.native_remove_field.per_byte_serialized",
        "object.native_contains_field.per_byte_serialized",
        "object.native_contains_field_with_value_type.per_byte_serialized",
