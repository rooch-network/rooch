...
pub use dynamic_field::{
    construct_dynamic_field_struct_tag, is_dynamic_field_type, is_field_struct_tag,
...
mod tests {
    ...
    fn test_module_store_named_object_id() {
        ...
        //The object id generated by crates/rooch-framework-tests/tests/cases/module/module_test.move
        let object_id = ObjectID::from_str(
