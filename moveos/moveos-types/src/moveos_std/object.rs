...
pub fn account_singleton_object_id(account: AccountAddress, struct_tag: &StructTag) -> ObjectID {
...
mod tests {
    ...
    #[test]
    fn test_account_singleton_object_id() {
        ...
        let coin_store_object_id = account_singleton_object_id(account, &struct_tag);
