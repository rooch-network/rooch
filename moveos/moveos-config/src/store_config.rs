...
impl StoreConfig {
    pub fn init(&self) -> Result<()> {
        let db_dir = get_rooch_config_dir().unwrap().join(R_DEFAULT_DB_DIR.as_path());
        if !db_dir.exists() {
    ...
    pub fn get_store_dir(&self) -> PathBuf {
        get_rooch_config_dir().unwrap().join(R_DEFAULT_DB_DIR.as_path())
    }
    ...
    //     self.base().data_dir().join(R_DEFAULT_DB_DIR.as_path())
    // }
...
//         self.base = Some(base);
//         if opt.store.max_open_files.is_some() {
//             self.max_open_files = opt.store.max_open_files;
//         }
//         if opt.store.max_total_wal_size.is_some() {
//             self.max_total_wal_size = opt.store.max_total_wal_size;
//         }
//         if opt.store.cache_size.is_some() {
//             self.cache_size = opt.store.cache_size;
//         }
//         if opt.store.bytes_per_sync.is_some() {
//             self.bytes_per_sync = opt.store.bytes_per_sync;
//         }
//         if opt.store.wal_bytes_per_sync.is_some() {
//             self.wal_bytes_per_sync = opt.store.wal_bytes_per_sync;
//         }
//         Ok(())
//     }
// }
