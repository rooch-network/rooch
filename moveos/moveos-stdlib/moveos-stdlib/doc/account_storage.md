...
-  [Function `borrow_account_storage`](#0x2_account_storage_borrow_account_storage)
-  [Function `borrow_account_storage_mut`](#0x2_account_storage_borrow_account_storage_mut)
-  [Function `borrow_resource_from_account_storage`](#0x2_account_storage_borrow_resource_from_account_storage)
-  [Function `borrow_mut_resource_from_account_storage`](#0x2_account_storage_borrow_mut_resource_from_account_storage)
-  [Function `add_resource_to_account_storage`](#0x2_account_storage_add_resource_to_account_storage)
-  [Function `remove_resource_from_account_storage`](#0x2_account_storage_remove_resource_from_account_storage)
-  [Function `exists_resource_at_account_storage`](#0x2_account_storage_exists_resource_at_account_storage)
-  [Function `exists_module_at_account_storage`](#0x2_account_storage_exists_module_at_account_storage)
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_named_table_id">named_table_id</a>(account: <b>address</b>, table_type: u64): <a href="object_id.md#0x2_object_id_ObjectID">object_id::ObjectID</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_named_table_id">named_table_id</a>(account: <b>address</b>, table_type: u64): ObjectID{
...
<a name="0x2_account_storage_borrow_account_storage"></a>

## Function `borrow_account_storage`



<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_account_storage">borrow_account_storage</a>(<a href="object_storage.md#0x2_object_storage">object_storage</a>: &<a href="object_storage.md#0x2_object_storage_ObjectStorage">object_storage::ObjectStorage</a>, account: <b>address</b>): &<a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_account_storage">borrow_account_storage</a>(<a href="object_storage.md#0x2_object_storage">object_storage</a>: &ObjectStorage, account: <b>address</b>): &<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>{
    <b>let</b> <a href="object_id.md#0x2_object_id">object_id</a> = <a href="object_id.md#0x2_object_id_address_to_object_id">object_id::address_to_object_id</a>(account);
    <b>let</b> <a href="object.md#0x2_object">object</a> = <a href="object_storage.md#0x2_object_storage_borrow">object_storage::borrow</a>&lt;<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>&gt;(<a href="object_storage.md#0x2_object_storage">object_storage</a>, <a href="object_id.md#0x2_object_id">object_id</a>);
...
<a name="0x2_account_storage_borrow_account_storage_mut"></a>

## Function `borrow_account_storage_mut`



<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_account_storage_mut">borrow_account_storage_mut</a>(<a href="object_storage.md#0x2_object_storage">object_storage</a>: &<b>mut</b> <a href="object_storage.md#0x2_object_storage_ObjectStorage">object_storage::ObjectStorage</a>, account: <b>address</b>): &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_account_storage_mut">borrow_account_storage_mut</a>(<a href="object_storage.md#0x2_object_storage">object_storage</a>: &<b>mut</b> ObjectStorage, account: <b>address</b>): &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>{
    <b>let</b> <a href="object_id.md#0x2_object_id">object_id</a> = <a href="object_id.md#0x2_object_id_address_to_object_id">object_id::address_to_object_id</a>(account);
    <b>let</b> <a href="object.md#0x2_object">object</a> = <a href="object_storage.md#0x2_object_storage_borrow_mut">object_storage::borrow_mut</a>&lt;<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>&gt;(<a href="object_storage.md#0x2_object_storage">object_storage</a>, <a href="object_id.md#0x2_object_id">object_id</a>);
...
<a name="0x2_account_storage_borrow_resource_from_account_storage"></a>

## Function `borrow_resource_from_account_storage`

Borrow a resource from the AccountStorage


<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_resource_from_account_storage">borrow_resource_from_account_storage</a>&lt;T: key&gt;(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>): &T
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_resource_from_account_storage">borrow_resource_from_account_storage</a>&lt;T: key&gt;(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>): &T {
    <a href="type_table.md#0x2_type_table_borrow">type_table::borrow</a>&lt;T&gt;(&self.resources)
}
</code></pre>
...
<a name="0x2_account_storage_borrow_mut_resource_from_account_storage"></a>

## Function `borrow_mut_resource_from_account_storage`

Borrow a mut resource from the AccountStorage


<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_mut_resource_from_account_storage">borrow_mut_resource_from_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>): &<b>mut</b> T
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_borrow_mut_resource_from_account_storage">borrow_mut_resource_from_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>): &<b>mut</b> T {
    <a href="type_table.md#0x2_type_table_borrow_mut">type_table::borrow_mut</a>&lt;T&gt;(&<b>mut</b> self.resources)
}
</code></pre>
...
<a name="0x2_account_storage_add_resource_to_account_storage"></a>

## Function `add_resource_to_account_storage`

Add a resource to the account storage


<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_add_resource_to_account_storage">add_resource_to_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>, resource: T)
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_add_resource_to_account_storage">add_resource_to_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>, resource: T){
    //TODO should <b>let</b> the <a href="type_table.md#0x2_type_table">type_table</a> <b>native</b> add function <b>to</b> check the resource is <b>exists</b>?
    <b>assert</b>!(!<a href="type_table.md#0x2_type_table_contains">type_table::contains</a>&lt;T&gt;(&self.resources), <a href="account_storage.md#0x2_account_storage_EResourceAlreadyExists">EResourceAlreadyExists</a>);
    <a href="type_table.md#0x2_type_table_add">type_table::add</a>(&<b>mut</b> self.resources, resource);
}
</code></pre>
...
<a name="0x2_account_storage_remove_resource_from_account_storage"></a>

## Function `remove_resource_from_account_storage`

Remove a resource from the account storage


<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_remove_resource_from_account_storage">remove_resource_from_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>): T
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_remove_resource_from_account_storage">remove_resource_from_account_storage</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>): T {
    <b>assert</b>!(<a href="type_table.md#0x2_type_table_contains">type_table::contains</a>&lt;T&gt;(&self.resources), <a href="account_storage.md#0x2_account_storage_EResourceNotExists">EResourceNotExists</a>);
    <a href="type_table.md#0x2_type_table_remove">type_table::remove</a>&lt;T&gt;(&<b>mut</b> self.resources)
}
</code></pre>
...
<a name="0x2_account_storage_exists_resource_at_account_storage"></a>

## Function `exists_resource_at_account_storage`



<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_exists_resource_at_account_storage">exists_resource_at_account_storage</a>&lt;T: key&gt;(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>): bool
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_exists_resource_at_account_storage">exists_resource_at_account_storage</a>&lt;T: key&gt;(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>) : bool {
    <a href="type_table.md#0x2_type_table_contains">type_table::contains</a>&lt;T&gt;(&self.resources)
}
</code></pre>
...
<a name="0x2_account_storage_exists_module_at_account_storage"></a>

## Function `exists_module_at_account_storage`



<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_exists_module_at_account_storage">exists_module_at_account_storage</a>(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">account_storage::AccountStorage</a>, name: <a href="_String">string::String</a>): bool
</code></pre>
...
<pre><code><b>fun</b> <a href="account_storage.md#0x2_account_storage_exists_module_at_account_storage">exists_module_at_account_storage</a>(self: &<a href="account_storage.md#0x2_account_storage_AccountStorage">AccountStorage</a>, name: String) : bool {
    <a href="table.md#0x2_table_contains">table::contains</a>(&self.modules, name)
}
</code></pre>
