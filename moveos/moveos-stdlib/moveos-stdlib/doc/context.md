...
-  [Function `new_named_object`](#0x2_context_new_named_object)
-  [Function `new_account_named_object_uid`](#0x2_context_new_account_named_object_uid)
-  [Function `new_account_named_object`](#0x2_context_new_account_named_object)
-  [Function `new_custom_object_uid`](#0x2_context_new_custom_object_uid)
-  [Function `new_custom_object`](#0x2_context_new_custom_object)
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="tx_context.md#0x2_tx_context">tx_context</a>(_self: &<a href="context.md#0x2_context_Context">context::Context</a>): &<a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>
</code></pre>
...
<pre><code><b>public</b>(<b>friend</b>) <b>fun</b> <a href="context.md#0x2_context_tx_context_mut">tx_context_mut</a>(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>): &<b>mut</b> <a href="tx_context.md#0x2_tx_context_TxContext">tx_context::TxContext</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_fresh_address">fresh_address</a>(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_fresh_uid">fresh_uid</a>(self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>): <a href="object_id.md#0x2_object_id_UID">object_id::UID</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_add">add</a>&lt;T: <b>copy</b>, drop, store&gt;(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>, value: T)
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_get">get</a>&lt;T: <b>copy</b>, drop, store&gt;(_self: &<a href="context.md#0x2_context_Context">context::Context</a>): <a href="_Option">option::Option</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="tx_meta.md#0x2_tx_meta">tx_meta</a>(_self: &<a href="context.md#0x2_context_Context">context::Context</a>): <a href="tx_meta.md#0x2_tx_meta_TxMeta">tx_meta::TxMeta</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_tx_gas_payment_account">tx_gas_payment_account</a>(_self: &<a href="context.md#0x2_context_Context">context::Context</a>): <b>address</b>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="tx_result.md#0x2_tx_result">tx_result</a>(_self: &<a href="context.md#0x2_context_Context">context::Context</a>): <a href="tx_result.md#0x2_tx_result_TxResult">tx_result::TxResult</a>
</code></pre>
...
<a name="0x2_context_new_object_uid"></a>

## Function `new_object_uid`

Create a new Object UID, then call <code><a href="object.md#0x2_object_new">object::new</a></code> to create a new Object


<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_new_object_uid">new_object_uid</a>&lt;T: key&gt;(self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>): <a href="object_id.md#0x2_object_id_TypedUID">object_id::TypedUID</a>&lt;T&gt;
</code></pre>
...
<a name="0x2_context_new_named_object_uid"></a>

## Function `new_named_object_uid`

Create a new named Object UID, then call <code><a href="object.md#0x2_object_new">object::new</a></code> to create a new Object


<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_new_named_object_uid">new_named_object_uid</a>&lt;T: key&gt;(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>): <a href="object_id.md#0x2_object_id_TypedUID">object_id::TypedUID</a>&lt;T&gt;
</code></pre>



<a name="0x2_context_new_named_object"></a>
...
<a name="0x2_context_new_account_named_object_uid"></a>

## Function `new_account_named_object_uid`
...
<a name="0x2_context_new_account_named_object"></a>
...
<a name="0x2_context_new_custom_object_uid"></a>

## Function `new_custom_object_uid`

Create a new custom Object UID, then call <code><a href="object.md#0x2_object_new">object::new</a></code> to create a new Object


<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_new_custom_object_uid">new_custom_object_uid</a>&lt;ID: drop, T: key&gt;(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>, id: ID): <a href="object_id.md#0x2_object_id_TypedUID">object_id::TypedUID</a>&lt;T&gt;
</code></pre>



<a name="0x2_context_new_custom_object"></a>
...
<pre><code>#[private_generics(#[T])]
<b>public</b> <b>fun</b> <a href="context.md#0x2_context_new_custom_object">new_custom_object</a>&lt;ID: drop, T: key&gt;(_self: &<b>mut</b> <a href="context.md#0x2_context_Context">context::Context</a>, id: ID, value: T): <a href="object.md#0x2_object_Object">object::Object</a>&lt;T&gt;
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="context.md#0x2_context_exists_object">exists_object</a>&lt;T: key&gt;(_self: &<a href="context.md#0x2_context_Context">context::Context</a>, <a href="object_id.md#0x2_object_id">object_id</a>: <a href="object_id.md#0x2_object_id_ObjectID">object_id::ObjectID</a>): bool
</code></pre>
