  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          <svg width="22.365" height="42.84" viewBox="0 0 71 136" fill="none" xmlns="http://www.w3.org/2000/svg">
