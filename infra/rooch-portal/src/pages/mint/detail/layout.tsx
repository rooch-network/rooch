        ...
        <div className="flex flex-col w-full items-start justify-start gap-3">
          <div className="flex flex-col w-full items-start justify-start gap-5 font-medium">
            <div
              ...
              {
                tokenInfo ? <div className="w-36">
                    <div className="flex flex-row items-center justify-start gap-3">
                      <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-50">{tokenInfo.coin.symbol}</h1>
                      <Badge
                        variant="outline"
            ...
            {tokenInfo ? <div
              className="flex items-center justify-start gap-2 text-sm text-muted-foreground/75 dark:text-muted-foreground">
              <div className="w-24">
            ...
            {tokenInfo ? <div
              ...
              <span
                className="border border-accent dark:border-none dark:bg-zinc-800 py-0.5 px-2 rounded-lg text-gray-800 dark:text-gray-50 tracking-tight ">
                         {balance ? formatCoin(Number(balance.balance), balance.decimals, balance.decimals): 0}
                       </span>
            </div> : <Skeleton width={150} />}
            {
              tokenInfo ?
                <div
                  className="flex items-center justify-start w-full gap-2 text-sm text-muted-foreground/75 dark:text-muted-foreground">
                  <div className="w-24"><span>Process :</span></div>
                  <div className="ml-4 w-full"><Progress value={progress} /></div>
