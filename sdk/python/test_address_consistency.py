...
@pytest.mark.asyncio
async def test_simple_address_consistency(rooch_client):
    ...
    assert keypair_address == signer_address == bitcoin_rooch_address, "Address generation methods should be consistent"
