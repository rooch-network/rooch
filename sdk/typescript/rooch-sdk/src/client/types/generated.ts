...
export type FieldStateFilterView =
  /** Query by object id. */
  {
    object_id: string
  }
...
export interface IndexerFieldStateView {
  created_at: string
  key_hex: string
  key_type: string
  object_id: string
  ...
  tx_order: string
  updated_at: string
  value?: AnnotatedMoveValueView | null
  value_type: string
}
export interface IndexerObjectStateView {
  ...
  tx_order: string
  updated_at: string
  value?: AnnotatedMoveStructView | null
}
 ...
 * item.
 */
export interface PaginatedIndexerFieldStateViews {
  data: IndexerFieldStateView[]
  has_next_page: boolean
  next_cursor?: IndexerStateID | null
}
/**
