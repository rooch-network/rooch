  ...
  describe('WebAuthn Utils and Envelope Builder', () => {
    ...
    const mockAssertionData = {
      signature: new Uint8Array([
        0x30, 0x44, 0x02, 0x20, 0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc, 0xde, 0xf0, 0x11, 0x22, 0x33,
        0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff, 0x00, 0x11, 0x22,
        0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x02, 0x20, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77,
      ...
      authenticatorData: new Uint8Array([
        ...
        0x97, 0x63, 0x01, 0x00, 0x00, 0x00, 0x00,
      ]),
    ...
    describe('WebAuthnUtils', () => {
      it('should validate correct challenge', () => {
        const isValid = WebAuthnUtils.validateChallenge(
      ...
      it('should compute verification message correctly', () => {
        ...
        const authenticatorPart = verificationMessage.slice(
          0,
          mockAssertionData.authenticatorData.length,
        )
        expect(Array.from(authenticatorPart)).toEqual(
          Array.from(mockAssertionData.authenticatorData),
        )
      })
