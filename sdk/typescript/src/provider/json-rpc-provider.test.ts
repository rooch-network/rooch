...
describe('provider', () => {
    ...
    describe('#executeViewFunction', () => {
        ...
        it('should execute view function ok', async () => {
            ...
            try {
                const fnId = '0x9fb8a2b8b84ea08804c5830c9fca7b6850cdb1a37aca58d33fea861ea1a515af::counter::value'
        ...
        it('should execute view function error', async () => {
            ...
            try {
                const fnId = '0xc74a6f9397b0eacd8fec9e95e9dc671da9ec69d3088688226070183edf84516::counter::value'
