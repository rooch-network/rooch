...
process_move_files "${parent_directory}/frameworks/rooch-framework/"
process_move_files "${parent_directory}/frameworks/moveos-stdlib/"
process_move_files "${parent_directory}/frameworks/bitcoin-move/"
