...
module bitcoin_move::genesis{
    ...
    fun init(){
        ...
        //TODO put the reorg_pending_blocks in the genesis context when reset the genesis
        let reorg_pending_blocks = 0;
        pending_block::genesis_init(reorg_pending_blocks);
    }
