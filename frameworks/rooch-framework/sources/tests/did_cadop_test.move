...
module rooch_framework::did_cadop_test {
    ...
    //     let user_vm_pk_multibase = did_test_common::generate_test_ed25519_multibase_key();
    ...
    // #[test]
    // #[expected_failure(abort_code = 24, location = rooch_framework::did)] // ErrorMultipleDIDKeyControllersNotAllowed
    ...
    //     let valid_did_key = string::utf8(b"did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK");
    ...
    //     let valid_ed25519_did_key = string::utf8(b"did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK");
    ...
    //     let valid_secp256k1_did_key = string::utf8(b"did:key:zQ3shokFTS3brHcDQrn82RUDfCZESWL1ZdCEJwekUDPQiYBme");
    //     let parsed_secp256k1 = did::parse_did_string(&valid_secp256k1_did_key);
    //     let formatted_secp256k1 = did::format_did(&parsed_secp256k1);
    //     assert!(formatted_secp256k1 == valid_secp256k1_did_key, 12302);
    // }
    ...
    //     let passkey_did_key_string = string::utf8(b"did:key:z6MkhaXgBZDvotDkL5257faiztiGiC2QtKLGpbnnEGta2doK");
    //     let passkey_vm_pk_multibase = did_test_common::generate_test_ed25519_multibase_key();
    ...
    //     // Create DID with passkey as controller
    //     did::create_did_object_via_cadop_entry_test_only(
    //         &custodian_signer,
    //         passkey_did_key_string,
    //         passkey_vm_pk_multibase,
    //         string::utf8(b"Ed25519VerificationKey2020"),
    //         string::utf8(b"passkey"),
    //         custodian_main_did_string,
    //         custodian_service_pk_multibase,
    //         string::utf8(b"EcdsaSecp256k1VerificationKey2019"),
    //         string::utf8(b"custodian-service")
    //     );
