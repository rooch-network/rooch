...
module rooch_framework::coin {
    ...
    use moveos_std::object::{Self, ObjectID, Object, address_to_object_id};
    ...
    // // Ensure the objectID generated by coin_info_id_by_type_name is the same as coin_info_id<T>
    // // public fun coin_info_id_by_type_name(coin_type: string::String): ObjectID {
    //     // // Get the type name of CoinInfo<CoinTypePlaceholder>
    //     // let type_with_placeholder = type_info::type_name<CoinInfo<CoinTypePlaceholder>>();
    //     //
    //     // // Find the placeholder string in the type name
    //     // let placeholder_type_name = type_info::type_name<CoinTypePlaceholder>();
    //     //
    //     // // Replace the placeholder with the actual coin_type
    //     // // We need to extract only the placeholder part from the full type name
    //     // let placeholder_start = string::index_of(&type_with_placeholder, &placeholder_type_name);
    //     // assert!(placeholder_start < (string::length(&type_with_placeholder) as u64), ErrorCoinTypeInvalid);
    //     //
    //     // // Calculate the position after the placeholder to get the suffix
    //     // let placeholder_end = placeholder_start + string::length(&placeholder_type_name);
    //     // let suffix = string::sub_string(&type_with_placeholder, placeholder_end, string::length(&type_with_placeholder));
    //     //
    //     // // Construct the new type string by replacing the placeholder with coin_type
    //     // let prefix = string::sub_string(&type_with_placeholder, 0, placeholder_start);
    //     // // Ensure the coin_type is the same as the type_info::type_name<CoinType>
    //     // let coin_type_name = type_info::type_name_by_type_name(coin_type);
    //     // let type_string = string::utf8(b"");
    //     // string::append(&mut type_string, prefix);
    //     // string::append(&mut type_string, coin_type_name);
    //     // string::append(&mut type_string, suffix);
    //     //
    //     // // Ensure the objectID generated below is the same as the one generated by object::named_object_id
    //     // address_to_object_id(
    //     //     address::from_bytes(
    //     //         hash::sha3_256(
    //     //             std::string::into_bytes(type_string)
    //     //         )
    //     //     )
    //     // )
    //
    ...
    // }
    //
    // public fun destroy_zero_v2(zero_coin: GenericCoin) {
    //     assert!(value_v2(&zero_coin) == 0, ErrorDestroyOfNonZeroCoin);
    // }
    //
    // public fun extract_v2(coin: &mut GenericCoin, amount: u256): GenericCoin {
    //     let coin_type = coin.coin_type;
    //     assert!(coin.value >= amount, ErrorInsufficientBalance);
    //     coin.value = coin.value - amount;
    //     GenericCoin { coin_type, value: amount }
    // }
    //
    // // public fun extract_all_by_type(coin_type: string::String, coin: &mut GenericCoin): GenericCoin {
    // public fun extract_all_v2(coin: &mut GenericCoin): GenericCoin {
    //     let coin_type = coin.coin_type;
    //     let total_value = coin.value;
    //     coin.value = 0;
    //     GenericCoin { coin_type, value: total_value }
    // }
    //
    // // public fun merge_by_type(coin_type: string::String, dst_coin: &mut GenericCoin, source_coin: GenericCoin) {
    // public fun merge_v2(dst_coin: &mut GenericCoin, source_coin: GenericCoin) {
    ...
    //     let GenericCoin { coin_type: _coin_type, value } = source_coin;
    //     dst_coin.value = dst_coin.value + value;
    // }
    //
    ...
    //
    // public fun zero_v2(coin_type: string::String): GenericCoin {
    //     pack_v2(coin_type, 0)
    // }
    //
    ...
    // }
    //
    // public fun mint_v2(coin_info: &mut Object<CoinInfoV2>, amount: u256): GenericCoin {
    //     mint_internal_v2(coin_info, amount)
    // }
    //
    // public fun mint_extend_v2(coin_info: &mut Object<CoinInfoV2>, amount: u256): GenericCoin {
    //     mint_internal_v2(coin_info, amount)
    // }
    //
    // public fun burn_v2(coin_type: string::String, coin_info: &mut Object<CoinInfoV2>, coin: GenericCoin) {
    //     burn_internal_v2(coin_type, coin_info, coin)
    // }
    //
    // public fun burn_extend_v2(coin_type: string::String, coin_info: &mut Object<CoinInfoV2>, coin: GenericCoin) {
    //     burn_internal_v2(coin_type, coin_info, coin)
    // }
    //
    // // fun mint_internal_by_type(coin_type: string::String, coin_info_obj: &mut Object<CoinInfoV2>, amount: u256): GenericCoin {
    // fun mint_internal_v2(coin_info_obj: &mut Object<CoinInfoV2>, amount: u256): GenericCoin {
    ...
    // }
    //
    // // fun burn_internal_by_type(coin_type: string::String, coin_info_obj: &mut Object<CoinInfoV2>, coin: GenericCoin) {
    // fun burn_internal_v2(coin_info_obj: &mut Object<CoinInfoV2>, coin: GenericCoin) {
    //     let coin_type = coin.coin_type;
    ...
    // /// Helper function for getting the value from a GenericCoin
    // // public fun value(coin: &GenericCoin): u256 {
    // //     coin.value
    // // }
    //
    // public fun destroy_for_testing_by_type(coin_type: string::String, coin: GenericCoin) {
    //     let GenericCoin { coin_type: _, value: _ } = coin;
    // }
}
