...
module rooch_framework::coin {
    ...
    public fun coin_info_id_v2(coin_type: string::String): ObjectID {
        ...
        assert!(placeholder_start != (string::length(&type_with_placeholder) as u64), 1000);
        ...
        string::append(&mut type_string, coin_type);
        string::append(&mut type_string, suffix);
        
        // Generate the object ID from the type string
