...
module rooch_framework::coin {
    ...
    // // }
    //
    public fun check_coin_info_registered_with_type(coin_type: string::String) {
        assert!(is_registered_with_type(coin_type), ErrorCoinInfoNotRegistered);
    }
    //
    public fun is_registered_with_type(coin_type: string::String): bool {
        let object_id = coin_info_id_with_type(coin_type);
    ...
    // Ensure the objectID generated by coin_info_id_with_type is the same as coin_info_id<T>
    public fun coin_info_id_with_type(coin_type: string::String): ObjectID {
        ...
        let coin_type_name = type_info::type_name_with_type(coin_type);
    ...
    ///
    public fun coin_type(coin: &CoinV2): string::String {
        coin.coin_type
    }
