...
module moveos_std::object {
    ...
    // #[private_generics(T)]
    // /// Create a new account named object, the ObjectID is generated by the account address, type_name of `T` and the type
    // public fun new_account_named_object_with_type<T: key>(account: address, value: T, type: string::String): Object<T> {
    //     let id = account_named_object_id_with_type<T>(account, type);
    //     new_with_object_id(id, value)
    // }
