...
module moveos_std::type_info {
    ...
    // Ensure the return of type_name_with_type(type) is the same as the type_name<T>
    native public fun type_name_with_type(type_name: string::String): string::String;
