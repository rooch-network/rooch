...
use bitcoin::{Address, SignedAmount};
...
impl OrdinalAPI for Server {
    ...
    fn get_block(&self, block_hash: BlockHash, verbosity: u64) -> RpcResult<String> {
    ...
    fn get_transaction(&self, txid: Txid, _include_watchonly: Option<bool>) -> RpcResult<Value> {
    ...
    fn finalize_psbt(&self, psbt: String, _extract: Option<bool>) -> RpcResult<FinalizePsbtResult> {
