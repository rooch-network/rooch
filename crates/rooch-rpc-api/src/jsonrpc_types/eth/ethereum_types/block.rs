...
use crate::jsonrpc_types::{bytes::Bytes, eth::transaction::Transaction};

use super::{lib::{Address, H256, U256, U64}, hash::H64, bloom::Bloom, other_fields::OtherFields, withdrawal::Withdrawal};
...
#[derive(Copy, Clone, Debug, Default, PartialEq, Eq, Hash, JsonSchema)]
#[serde(rename_all = "camelCase")]
