...
module rooch_framework::ecdsa_k1_recoverable {
    ...
    #[test]
    #[expected_failure(location=Self, abort_code = 720897)]  // ErrorFailToRecoverPubKey
    ...
    #[test]
    #[expected_failure(location=Self, abort_code = 65538)] // ErrorInvalidSignature
    ...
    #[test]
    #[expected_failure(location=Self, abort_code = 65539)] // ErrorInvalidSignature 
