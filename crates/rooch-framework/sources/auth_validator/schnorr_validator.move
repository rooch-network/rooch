...
module rooch_framework::schnorr_validator {
   ...
   // this test ensures that the test_schnorr_public_key_to_authentication_key function is compatible with the one in the rust code
   #[test]
   fun test_schnorr_public_key_to_authentication_key(){
