...
description: "As a proponent of the Move programming language, every time I promote Move to developers, I always encounter the same question: What are the advantages of Move? Why Move? This article delves into the unique advantages of Move and its potential in the blockchain ecosystem."
author: jolestar
date: 2023/02/18
...
3. [Soulbound](https://vitalik.eth.limo/general/2022/01/26/soulbound.html) Vitalik's article about NFT Soulbound
