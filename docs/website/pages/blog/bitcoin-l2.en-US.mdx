...
description: 'This article provides a comprehensive analysis of Bitcoin L2 from both technical and ecosystem perspectives, examining key features like BTC assets, block space, and programmability. It proposes an inclusive view of L2 development and details four main approaches to Bitcoin extension: bridging, smart contract layer, Indexer mode, and Stackable L2.'
author: jolestar
date: 2024/03/04
category: Developer
---
