---
title: Rooch 周报 2023-08-21
description: "实现 Session Key 的新特性，实现累加器存储，实现 GasMeter，新增 CLI 命令，重构 framework 和 validator，对相关文档进行优化和改进"
...
- 详细讨论多链的代币如何映射到 Rooch 上的方案，参见 [#626](https://github.com/rooch-network/rooch/issues/626)
- 讨论在以太坊网络上定义 Rooch 的链 ID
- 讨论 Gas 和 Gas provider
- 展示 Dashboard
