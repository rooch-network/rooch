...
category: Campaign
date: 2024/11/14
description: 'Phase II of Rooch Network's bug bounty program with a $200,000 reward pool. Rewards for critical vulnerabilities (minting, privilege escalation, verification bypasses), medium vulnerabilities (node crashes, contract vulnerabilities), and low-risk issues. Program runs from Nov 15th to Dec 15th, 2024.'
