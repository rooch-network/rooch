...
date: 2024/12/10
description: ''
image: '/blog/babylon-stake/babylon-stake.png'
---
...
![](/blog/babylon-stake/babylon-stake.png)
...
If you are participating in Babylon’s Bitcoin Staking Cap3, your journey doesn’t end here. **You can unlock even greater potential by utilizing your staked Bitcoin on Rooch’s Grow Bitcoin platform—an ecosystem accelerator designed to connect Bitcoin users and stakers with various projects.** Moreover, users who previously participated in **Babylon’s Bitcoin Staking Cap2** are also eligible to access these additional rewards on Rooch Network.
...
With Babylon’s Bitcoin Staking Cap3 concluded, now is the perfect time to maximize the utility of your BTC. Rooch Network empowers you to take control of your staked Bitcoin, enabling new earning possibilities while maintaining the integrity of your assets.
...
To get started, **claim your free RGAS, the gas token** of Rooch Network, by visiting Rooch faucet if you have UTXO in your Bitcoin wallet. Begin exploring Rooch Network’s features and discover the future of Bitcoin liquidity.
