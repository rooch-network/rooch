...
* [Multi-chain Settlement](../tech-highlights/multi-chain-settlement)
...
* Improved [Object](../docs/developer-guids/object) and [StorageAbstraction](../docs/dive-into-rooch/storage-abstraction) designs.
...
For currently supported API, see: [Rooch JSON RPC](../docs/developer-guids/rpc).
