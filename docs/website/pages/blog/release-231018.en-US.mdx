...
description: "Rooch v0.2 has been released, featuring AccountAbstraction, introducing a Dashboard, and launching a developer testnet. This version improves local configuration files and private key management, supports recovering private keys through mnemonics, enhances local private key security, and implements storage for states, transactions, and events."
author: jolestar
category: News
date: 2023/10/18
---
