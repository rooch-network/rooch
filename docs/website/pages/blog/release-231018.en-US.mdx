...
* [Multi-chain Settlement](../docs/tech-highlights/multi-chain-settlement.en-US.mdx)
...
* Improved [Object](../docs/developer-guides/object.en-US.mdx) and [StorageAbstraction](../docs/dive-into-rooch/storage-abstraction.en-US.mdx) designs.
...
For currently supported API, see: [Rooch JSON RPC](../docs/developer-guides/rpc.en-US.mdx).
