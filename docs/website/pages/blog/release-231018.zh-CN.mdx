...
关于 Rooch 账户抽象的详细设计请参看：[账户抽象的设计与实现](../learn/core-concepts/accounts/account-abstraction-implementation.zh-CN.mdx)。
...
* 改进了 [Object](../learn/core-concepts/objects/object.zh-CN.mdx) 以及 [StorageAbstraction](../learn/core-concepts/objects/storage-abstraction.zh-CN.mdx) 的设计。
...
如何使用开发者测试网，请参考文档：[连接开发者测试网络](../build/getting-started/connect-to-rooch/connect-devnet.zh-CN.mdx)
