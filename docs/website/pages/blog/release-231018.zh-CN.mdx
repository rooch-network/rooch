...
* [多链结算](../tech-highlights/multi-chain-settlement)
...
* 改进了 [Object](../docs/developer-guids/object) 以及 [StorageAbstraction](../docs/dive-into-rooch/storage-abstraction) 的设计。
...
Rooch 当前支持的接口请参看：[Rooch JSON RPC](../docs/developer-guids/rpc)。
