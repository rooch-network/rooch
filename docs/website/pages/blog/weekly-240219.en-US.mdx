---
title: Rooch Weekly 2024-02-19
description: "In the past month, the Rooch team has completed access to the Bitcoin test network. Currently, you can experience functions such as inscription inscribe and display, optimize DA, improve command line tools and Dashboard, improve user documentation, and fix known issues"
