...
category: Campaign
date: 2025/01/08
description: 'Rooch Network 推出第三期漏洞赏金计划，总奖金池20万美元。针对高危漏洞（如造币、权限提升、验证绕过等）、中危漏洞（如节点崩溃、合约漏洞等）和低危漏洞（如性能问题、数据异常等）提供不同级别的奖励。活动将持续到主网上线。'
image: '/blog/bug-bounty/bounty3-zh.jpg'
---
...
![](/blog/bug-bounty/bounty3-zh.jpg)

Rooch Network 第二期漏洞赏金获得了各领域开发者及安全专家的积极参与 ，在他们的支持下，Rooch 官方修复了对应的漏洞, 进一步提升了网络的安全性和稳定性。

基于第二期活动的热烈反响和成功经验，以及Rooch Network准主网的不断平稳运行，我们即将启动第三期漏洞赏金活动，诚邀全球开发者和安全专家加入，共同发现和修复潜在的安全漏洞。此次活动的总奖金池依旧高达20万美元，期待您的积极参与！
