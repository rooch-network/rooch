...
- You can also click the `Invite With Twitter` button to send your invitation post to X. As long as other users bind X through the link in your post, you can also get `RGas` share revenue.
