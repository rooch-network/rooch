...
![timeline](/blog/interactive-game/timeline.png)
...
![ones-count](/blog/interactive-game/ones-count.png)

**Joe**: You've preemptively spoken again. On my x86_64:

![ones-count-x86](/blog/interactive-game/ones-count-x86.png)

Or：

![ones-count-simd](/blog/interactive-game/ones-count-simd.png)

----

**Moe**: Because I showed you source code. Talking is cheap. On my RISC-V:

![ones-count-riscv](/blog/interactive-game/ones-count-riscv.png)
