...
category: Campaign
date: 2024/09/13
description: 'First bug bounty program targeting global developers and security experts. Focus on critical vulnerabilities (like Move Verifier bypass, privilege escalation), medium vulnerabilities (like node crashes), and low-risk issues (like performance problems). $200,000 total reward pool over one month.'
