...
For more detailed design on storage abstraction, please refer to the [Storage Abstraction](../docs/dive-into-rooch/storage-abstraction) documentation.
