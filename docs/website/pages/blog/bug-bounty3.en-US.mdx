---
title: 'Rooch Network Bug Bounty Program Phase III - Share $200,000 in Rewards'
author: omnihand
category: Campaign
date: 2025/01/08
description: 'Rooch Network launches Phase III of its bug bounty program with a $200,000 reward pool. Rewards are offered for critical vulnerabilities (like minting, privilege escalation, verification bypasses), medium vulnerabilities (node crashes, contract vulnerabilities), and low-risk issues (performance problems, data anomalies). The program continues until mainnet launch.'
image: '/blog/bug-bounty/bounty3-en.png'
---
...
![](/blog/bug-bounty/bounty3-en.png)

Rooch Network's second bug bounty program saw enthusiastic participation from developers and security experts, leading to the successful identification and resolution of critical vulnerabilities. These contributions significantly enhanced the network's security and stability. You can review the detailed results of the second bug bounty program [here](https://rooch.network/blog/bug-bounty-result2).

As **Rooch Network operates smoothly in its pre-mainnet phase**, we are excited to announce the launch of our **third bug bounty program**. Building on the success and valuable experience from previous phases, we invite developers and security researchers from around the world to join us in safeguarding Rooch Network. With a $200,000 reward pool, we can’t wait to see your active contributions to making Rooch even stronger!
