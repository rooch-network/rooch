...
Rooch Network的首个漏洞赏金计划得到了各领域开发者和安全专家的积极参与。在他们的支持下，Rooch 成功修复了已发现的漏洞，增强了网络的安全性和稳定性。您可以在[此处](https://rooch.network/blog/bug-bounty-result)查看 Rooch 的第一个错误赏金计划的结果。基于第一阶段的积极响应和宝贵经验，随着 Rooch Network 预主网的临近，我们正在启动第二阶段的 bug 赏金阶段。我们热忱邀请全球开发者和安全专家与我们一起识别和解决潜在的安全漏洞。奖励池仍保持在令人印象深刻的 200,000 美元——期待您的积极参与！
