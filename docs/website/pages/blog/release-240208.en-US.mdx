...
Connect to the Bitcoin test network and use UniSat as the default wallet. For detailed usage, please refer to [Installing UniSat](../docs/user-guides/install-unisat.en-US.mdx).
...
This version has made a major reconstruction of object storage. Please refer to the [Object](../docs/developer-guides/object.en-US.mdx) for detailed usage to provide developers with a better development experience.

## Inscription

Currently, basic functions such as inscription inscribe, display, and query have been implemented. For detailed operations, please refer to [Inscription](../docs/user-guides/inscription.en-US.mdx).
...
* For usage instructions, please see: [Rooch Dashboard usage instructions](../docs/user-guides/dashboard.en-US.mdx).
...
For the interfaces currently supported by Rooch, please see: [Rooch JSON RPC](../docs/developer-guides/rpc.en-US.mdx).
...
How to use the test network, please refer to the document: [Connect to the test network](../docs/developer-guides/connect-testnet.en-US.mdx)
...
Rooch's milestones are driven by application scenarios, focusing on the experience of developers and users. The goal is to expand the boundaries of Web3 applications and explore the possibilities of mass adoption. To learn more and try Rooch, please refer to the [Getting Started](../docs/getting-started.en-US.md) documentation.
