...
description: "Rooch v0.3 is released, connecting to the Bitcoin network, implementing inscription interactive, and launching the Testnet. This version introduces the DA open network framework, supports various storage scenarios, provides object storage reconstruction, integrates the UniSat wallet, and offers extensive JSON RPC and SDK interfaces."
