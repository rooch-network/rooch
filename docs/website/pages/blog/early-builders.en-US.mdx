...
category: Campaign
date: 2024/06/04
description: 'Rooch Network launches the Early Builders Program, inviting developers to build DeFi, infrastructure, tools, gaming, metaverse, NFT, governance and other applications on its network. Offering 1,000,000 $ROOCH in rewards, including proposal incentives, demo rewards, and additional grant program support.'
