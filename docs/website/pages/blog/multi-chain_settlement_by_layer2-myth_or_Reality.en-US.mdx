---
title: Multi-chain settlement by Layer 2: Myth or Reality?
...
For more information on how Rooch implements transaction inclusion in Multi-chain systems, see → [Transaction Flow](/docs/tech-highlights/transaction_flow)

For more information on how Rooch implements generic L1 to L2 messaging in a Multi-chain system, see → [L1 to L2 Messaging](/docs/tech-highlights/l1_to_l2_messaging)

For more information on how Rooch implements generic L2 to L1 messaging in a Multi-chain system, see → [L2 to L1 Messaging](/docs/tech-highlights/l2_to_l1_messaging)
