...
4. If the Sequencer hides transactions, slashs can be imposed through [transaction sequence proofs](https://rooch.network/docs/tech-highlights/sequence-proof).
