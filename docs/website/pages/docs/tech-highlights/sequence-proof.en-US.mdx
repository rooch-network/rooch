...
Sequence Proof proves wether a transaction is at a specific position in a sequence, [maximizing security of pre-confirmations](https://vitalik.ca/general/2021/01/05/rollup.html).
