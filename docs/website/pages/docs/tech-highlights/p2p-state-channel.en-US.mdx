...
Also, Rooch supports [smart contracts in state channel](./02-channel-contract.md) through the features of Move, simplifying the design of game and DApp protocols on P2P networks.
