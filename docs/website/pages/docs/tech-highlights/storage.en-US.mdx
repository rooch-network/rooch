...
2. Developers can define access and extension restriction for storage structures using private generics, as explained in the [Private Generics](../developer-guides/private-generics.en-US.mdx) guide.
