...
2. Developers can define access and extension restriction for storage structures using private generics, as explained in the [Private Generics](../developer-guides/private-generics) guide.
...
For more detailed design documentation, please refer to the [Storage Abstraction](../dive-into-rooch/storage-abstraction) guide.
