...
Multi-chain address mapping is a fundamental aspect of [multi-chain settlement](./multi-chain-settlement.en-US.mdx). Rooch supports the automatic mapping of L1 (Layer 1) addresses to Rooch addresses or the ability to bind an existing Rooch address to an L1 address.
...
For more details about the implementation of account abstraction in Rooch, please refer to the [Design and Implementation of Account Abstraction](../dive-into-rooch/account-abstraction.en-US.mdx).
