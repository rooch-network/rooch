...
这点也是[多链结算](./multi-chain-settlement.zh-CN.mdx)的基础，Rooch 支持将 L1 的地址自动映射成 Rooch 的地址，或者在已有 Rooch 地址上绑定 L1 的地址。 
...
想了解更多关于 Rooch 账户抽象的实现细节，请参考 [账户抽象的设计与实现](../dive-into-rooch/account-abstraction.zh-CN.mdx)。
