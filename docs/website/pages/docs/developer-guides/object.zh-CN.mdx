...
｜object_storage::remove<T: key>(&mut ObjectStorage,ObjectID): Object<T>           | 通过 ObjectID删除 Object<T>，并返回 Object<T>|
...
7. [StorageAbstraction](../tech-highlights/storage_abstraction.zh-CN.md)
