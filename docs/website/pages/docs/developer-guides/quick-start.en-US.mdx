...
We separate the logic of initializing the counter from the `init` function. At this time, the `init` function simply calls the function `create_counter` that creates the counter and prints the ID of the counter object.

In the `create_counter` function, first initialize the counter, obtain the address of the signed transaction, then create the counter object and the ID of the counter object, then transfer the counter object to the address where the transaction was initiated, and finally return the object ID.

In the `increase` function that increments the count value, we call `borrow_mut` to obtain the mutable reference of the counter object. After we get the counter object, we can modify its internal value. As in the above operation, we implement counting by `+1` value increment.
...
2. Use `rooch object --id ID` to view the contents of the counter object:

```shell
rooch object --id 0xf049ae1d92f970ff1b9c397a49bb5f7c7668bfd5cf5b73035c183b574a7daabb

{
  "value": "0xf049ae1d92f970ff1b9c397a49bb5f7c7668bfd5cf5b73035c183b574a7daabb94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63000000000000000000",
  "value_type": "0x2::object::ObjectEntity<0x94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63::quick_start_object_counter::ObjectCounter>",
  "decoded_value": {
    "abilities": 0,
    "type": "0x2::object::ObjectEntity<0x94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63::quick_start_object_counter::ObjectCounter>",
    "value": {
      "flag": 0,
      "id": "0xf049ae1d92f970ff1b9c397a49bb5f7c7668bfd5cf5b73035c183b574a7daabb",
...
At this point, the value of the counter object has been initialized to `0`.

3. Call the `increase` function to increment the counter:

```shell
rooch move run --function default::quick_start_object_counter::increase --args object_id:0xf049ae1d92f970ff1b9c397a49bb5f7c7668bfd5cf5b73035c183b574a7daabb
```
...
{
  "value": "0xf049ae1d92f970ff1b9c397a49bb5f7c7668bfd5cf5b73035c183b574a7daabb94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63000100000000000000",
  "value_type": "0x2::object::ObjectEntity<0x94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63::quick_start_object_counter::ObjectCounter>",
  "decoded_value": {
    "abilities": 0,
    "type": "0x2::object::ObjectEntity<0x94bfa175058278af4afe25bb546f39bd4706d4c74539bbdc59c6d936b1695f63::quick_start_object_counter::ObjectCounter>",
