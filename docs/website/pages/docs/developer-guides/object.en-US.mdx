...
Rooch Object is also an example of the [Hot Potato](https://examples.sui.io/patterns/hot-potato.html) pattern in Move. Object does not have any abilities, so it cannot be dropped, copied, or stored. It can only be handled by functions provided by `ObjectStorage`.
...
7. [StorageAbstraction](../tech-highlights/storage_abstraction.en-US.md)
