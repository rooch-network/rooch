...
This section will introduce how to use Rooch CLI to start local services.
...
Because Rooch is in the process of rapid development and iteration, you will encounter compatibility issues when deploying contracts. At this time, you can use the `clean` command to clean up old data.
