...
For more details about the implementation of account abstraction in Rooch, please refer to the [Design and Implementation of Account Abstraction](./account-abstraction-implementation.en-US.mdx).
