...
2. Developers can define access and extension restriction for storage structures using private generics, as explained in the [Private Generics](../../build/rooch-framework/private-generics.en-US.mdx) guide.
...
For more detailed design documentation, please refer to the [Storage Abstraction](../core-concepts/objects/storage-abstraction.en-US.mdx) guide.
