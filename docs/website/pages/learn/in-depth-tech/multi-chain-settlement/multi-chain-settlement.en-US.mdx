...
For more information on how Rooch implements transaction inclusion in a multi-chain system, see → [Transaction Flow](/docs/dive-into-rooch/transaction-flow)

For more information on how Rooch implements generic L1 to L2 messaging in a multichain system, see → [L1 to L2 Messaging](/docs/dive-into-rooch/l1-to-l2-messaging)

For more information on how Rooch implements generic L2 to L1 messaging in multichain systems, see → [L2 to L1 Messaging](/docs/dive-into-rooch/l2-to-l1-messaging).
