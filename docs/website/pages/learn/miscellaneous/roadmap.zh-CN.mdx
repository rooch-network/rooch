...
实现基于 [DSTP](/learn/in-depth-tech/dstp) 的应用网络，探索 CSV 类资产在应用间的流通，并通过 VApp 实现应用数据资产化及上链。
...
5. 代币使用：PreMainnet 上仅使用 [RGas](/learn/core-concepts/rgas) 支付 Gas 费。Rooch 的主网代币将在正式 Mainnet 上发布。
