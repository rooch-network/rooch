...
For detailed usage guide of Rooch, please refer to [this article](./portal-features/using-portal).
...
### How to use Liquility

For details, refer to the [Liquidity User Guide](./portal-features/liquidity).

### Using Rooch Cross-chain Bridge

Currently, USDTs on other chains can be spanned to Rooch through [Rooch Bridge](https://rooch.free.tech/rooch). Currently, USTDs on the Ethereum and Arbitrum chains are supported to span Rooch, or from Rooch to Ethereum and Arbitrum.

For detailed use, please refer to the [Rooch Bridge Usage Guide](./portal-features/swap-usdt.en-US.mdx).
