...
The main network only needs to ensure that the UniSat wallet has UTXO and [Claim RGas](https://portal.rooch.network/faucet) here to stake.
...
Rooch is three blocks slower than Bitcoin and needs to wait for synchronization.
