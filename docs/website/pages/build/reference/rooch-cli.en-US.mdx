...
When you install Rooch, the Rooch CLI is installed. See the [installation](../getting-started/installation.en-US.mdx) topic for prerequisites and installation instructions.
