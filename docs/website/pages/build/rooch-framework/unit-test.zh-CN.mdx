...
BUILDING unit_test
Running Move unit tests
2024-06-28T01:40:52.481931Z  INFO moveos_common::utils: set max open fds 8192
...
│    ·
│ 26 │         assert!(counter.count_value == 2, 999);
│    │         ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Test was not expected to error, but it aborted with code 999 originating in the module fc3c1fa4f1538deee1048fa066a1b0029f2cf428e21667e5a7d4d570626c112e::unit_test rooted here
│
│
└──────────────────
